...
public class ManagerDAO {
	...
	/*	*//**
			 ...
			 *//*
				 * @SuppressWarnings("rawtypes") public List findAll(Class clase, String
				 * propiedadOrderBy, boolean ascendente) { Query q; List listado; String
				 * sentenciaJPQL; if (propiedadOrderBy == null || propiedadOrderBy.length() ==
				 * 0) sentenciaJPQL = "SELECT o FROM " + clase.getSimpleName() + " o"; else { if
				 * (ascendente) sentenciaJPQL = "SELECT o FROM " + clase.getSimpleName() +
				 * " o ORDER BY :propiedadOrderBy asc"; else sentenciaJPQL = "SELECT o FROM " +
				 * clase.getSimpleName() + " o ORDER BY :propiedadOrderBy desc"; } q =
				 * em.createQuery(sentenciaJPQL); if (ModelUtil.isEmpty(propiedadOrderBy)==
				 * false) { q.setParameter("propiedadOrderBy", "o." + propiedadOrderBy); }
				 * listado = q.getResultList(); return listado;
				 * 
				 * }
				 */
	...
	public List findAll(Class clase, String propiedadOrderBy, boolean ascendente) {
		...
		System.out.println(clase.getSimpleName() + ": " + listado.size());
		return listado;
